...
```shell
1. 우분투는 apt 패키지 관리자를 사용한다. 따라서 먼저 패키지 목록을 업데이트 한다.
root@DESKTOP-I4COF21:~# sudo apt update -y
Get:1 http://security.ubuntu.com/ubuntu bionic-security InRelease [88.7 kB]
Hit:2 http://archive.ubuntu.com/ubuntu bionic InRelease
Get:3 http://archive.ubuntu.com/ubuntu bionic-updates InRelease [88.7 kB]
Get:4 http://security.ubuntu.com/ubuntu bionic-security/main amd64 Packages [605 kB]
Get:5 http://archive.ubuntu.com/ubuntu bionic-backports InRelease [74.6 kB]
Get:6 http://archive.ubuntu.com/ubuntu bionic-updates/main amd64 Packages [829 kB]
Get:7 http://security.ubuntu.com/ubuntu bionic-security/main Translation-en [196 kB]
Get:8 http://security.ubuntu.com/ubuntu bionic-security/restricted amd64 Packages [16.8 kB]
Get:9 http://security.ubuntu.com/ubuntu bionic-security/restricted Translation-en [5028 B]
Get:10 http://security.ubuntu.com/ubuntu bionic-security/universe amd64 Packages [628 kB]
Get:11 http://archive.ubuntu.com/ubuntu bionic-updates/main Translation-en [290 kB]
Get:12 http://security.ubuntu.com/ubuntu bionic-security/universe Translation-en [210 kB]
Get:13 http://archive.ubuntu.com/ubuntu bionic-updates/restricted amd64 Packages [26.0 kB]
Get:14 http://archive.ubuntu.com/ubuntu bionic-updates/restricted Translation-en [6976 B]
Get:15 http://archive.ubuntu.com/ubuntu bionic-updates/universe amd64 Packages [1035 kB]
Get:16 http://archive.ubuntu.com/ubuntu bionic-updates/universe Translation-en [320 kB]
Get:17 http://archive.ubuntu.com/ubuntu bionic-updates/multiverse amd64 Packages [9500 B]
Get:18 http://archive.ubuntu.com/ubuntu bionic-updates/multiverse Translation-en [4540 B]
Fetched 4433 kB in 13s (345 kB/s)
Reading package lists... Done
Building dependency tree
Reading state information... Done
131 packages can be upgraded. Run 'apt list --upgradable' to see them.

2. docker comuinity edition(docker ce)는 몇 가지 패키지에 의존하므로 apt 명령어를 이용해 몇가지 패키지를 설치한다.
root@DESKTOP-I4COF21:~# sudo apt install -y transport-https ca-certificates curl software-properties-common
Reading package lists... Done
Building dependency tree
Reading state information... Done
E: Unable to locate package transport-https

3. docker package 저장소에 apt를 등록한다. 이때 stable은 안정된 버전을 의미한다.
root@DESKTOP-I4COF21:~# sudo add-apt-repository "deb [arch=amd64] https://download.docker.com/linux/ubuntu $(lsb_release -cs) stable"
...
Fetched 163 kB in 3s (61.6 kB/s)
Reading package lists... Done

4. 다시 한 번 apt 패키지 목록을 업데이트 한다.
root@DESKTOP-I4COF21:~# sudo apt update -y
...
5. 설치할 버전을 지정해 docker ce를 설치한다. 이때 버전을 지정하지 않으면 안정된 가장 최신 버전이 설치된다.
...
6. docker 설치 확인
root@DESKTOP-I4COF21:~# docker --version
